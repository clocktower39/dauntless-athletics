...
export const camps: Camp[] = [
  ...
  },
  {
    icon: <img src="/images/camps/silhouette_backhandspring.png" style={{ ...classes.DauntlessCampIcon, borderRadius: '15%', }} />,
    Subject: "Back Handspring Clinic",
    StartTime: new Date(2026, 2, 14, 12, 0),
    EndTime: new Date(2026, 2, 14, 13, 30),
    color: "#f01313",
    place: "Dauntless Athletics",
    cost: { amount: 35, label: "per athlete" },
  ...
  },
  {
    ...
    StartTime: new Date(2026, 2, 14, 13, 30),
    EndTime: new Date(2026, 2, 14, 15, 0),
    color: "#f01313",
    place: "Dauntless Athletics",
    cost: { amount: 35, label: "per athlete" },
  ...
  },
  {
    icon: <img src="/images/camps/silhouette_aerial_cartwheel.png" style={{ ...classes.DauntlessCampIcon, borderRadius: '50%', }} />,
    Subject: "Aerial/ Acro Clinic",
    StartTime: new Date(2026, 2, 14, 15, 0),
    EndTime: new Date(2026, 2, 14, 16, 30),
    color: "#f01313",
    place: "Dauntless Athletics",
    cost: { amount: 35, label: "per athlete" },
  ...
  {
    icon: <img src="/images/camps/silhouette_group_stunting.png" style={{ ...classes.DauntlessCampIcon, borderRadius: '50%', }} />,
    Subject: "Community Open Gym (Ages 6+)",
    StartTime: new Date(2026, 1, 27, 18, 30),
    EndTime: new Date(2026, 1, 27, 20, 30),
    color: "#1b9e6a",
    place: "Dauntless Athletics",
    cost: "Free",
    description:
      "Sign-up required. Donations accepted at the door; proceeds benefit Kids Without A Cause Foundation.",
    link: {
      href: "https://portal.iclasspro.com/dauntlessathletics/camps/39",
      innerText: "Register",
    },
  },
  {
    icon: <img src="/images/camps/silhouette_backhandspring.png" style={{ ...classes.DauntlessCampIcon, borderRadius: "15%" }} />,
    Subject: "Back Handspring Clinic",
    StartTime: new Date(2026, 4, 9, 12, 0),
    EndTime: new Date(2026, 4, 9, 13, 30),
    color: "#d72638",
    place: "Dauntless Athletics",
    cost: { amount: 35, label: "per clinic" },
    description: "A focused clinic for athletes working on back handsprings, technique cleanup, and confidence on standing and running entries.",
    link: {
      href: "https://portal.iclasspro.com/dauntlessathletics/camps/19",
      innerText: "Register For Clinic",
    },
  },
  {
    icon: <img src="/images/camps/silhouette_back_tuck.png" style={{ ...classes.DauntlessCampIcon, borderRadius: "50%" }} />,
    Subject: "Hard Floor Clinic",
    StartTime: new Date(2026, 4, 9, 13, 30),
    EndTime: new Date(2026, 4, 9, 15, 0),
    color: "#065E99",
    place: "Dauntless Athletics",
    cost: { amount: 35, label: "per clinic" },
    description: "A focused hard-floor clinic for athletes who want cleaner technique, stronger landings, and better confidence transferring tumbling to competition surfaces.",
    link: {
      href: "https://portal.iclasspro.com/dauntlessathletics/camps/19",
      innerText: "Register For Clinic",
    },
  },
  {
    icon: <img src="/images/camps/silhouette_aerial_cartwheel.png" style={{ ...classes.DauntlessCampIcon, borderRadius: "50%" }} />,
    Subject: "Aerial / Acro Clinic",
    StartTime: new Date(2026, 4, 9, 15, 0),
    EndTime: new Date(2026, 4, 9, 16, 30),
    color: "#f01313",
    place: "Dauntless Athletics",
    cost: { amount: 35, label: "per clinic" },
    description: "A dedicated aerial and acro clinic for athletes working on walkovers, aerial progressions, and dance-acro connections.",
    link: {
      href: "https://portal.iclasspro.com/dauntlessathletics/camps/19",
      innerText: "Register For Clinic",
    },
  },
  {
    icon: <img src="/images/camps/silhouette_backhandspring.png" style={{ ...classes.DauntlessCampIcon, borderRadius: "15%" }} />,
    Subject: "Back Handspring Clinic",
    StartTime: new Date(2026, 5, 6, 12, 0),
    EndTime: new Date(2026, 5, 6, 13, 30),
    color: "#d72638",
    place: "Dauntless Athletics",
    cost: { amount: 35, label: "per clinic" },
    description: "A focused clinic for athletes working on back handsprings, technique cleanup, and confidence on standing and running entries.",
  ...
  },
  {
    icon: <img src="/images/camps/silhouette_back_tuck.png" style={{ ...classes.DauntlessCampIcon, borderRadius: "50%" }} />,
    Subject: "Hard Floor Clinic",
    StartTime: new Date(2026, 5, 6, 13, 30),
    EndTime: new Date(2026, 5, 6, 15, 0),
    color: "#065E99",
    place: "Dauntless Athletics",
    cost: { amount: 35, label: "per clinic" },
    description: "A focused hard-floor clinic for athletes who want cleaner technique, stronger landings, and better confidence transferring tumbling to competition surfaces.",
  ...
  },
  {
    icon: <img src="/images/camps/silhouette_aerial_cartwheel.png" style={{ ...classes.DauntlessCampIcon, borderRadius: "50%" }} />,
    Subject: "Aerial / Acro Clinic",
    StartTime: new Date(2026, 5, 6, 15, 0),
    EndTime: new Date(2026, 5, 6, 16, 30),
    color: "#f01313",
    place: "Dauntless Athletics",
    cost: { amount: 35, label: "per clinic" },
    description: "A dedicated aerial and acro clinic for athletes working on walkovers, aerial progressions, and dance-acro connections.",
  ...
  {
    icon: <SchoolIcon sx={{ ...classes.DauntlessCampIcon, color: "#000" }} />,
    Subject: "Summer Camp Week 1",
    StartTime: new Date(2026, 5, 8, 9, 0),
    EndTime: new Date(2026, 5, 10, 12, 0),
    color: "#d72638",
    place: "Dauntless Athletics",
    cost: { day: 55, week: 150, label: "per athlete" },
    description: "Three mornings of summer training focused on tumbling, jumps, conditioning, flexibility, and cheer skill development. Athletes can register by day or for the full week.",
    link: {
      href: "https://portal.iclasspro.com/dauntlessathletics/camps/28",
      innerText: "Register For Camp",
    },
    dateText: "June 8-10, 2026",
    timeText: "9:00 AM - 12:00 PM",
  },
  {
  ...
  {
    icon: <SchoolIcon sx={{ ...classes.DauntlessCampIcon, color: "#000" }} />,
    Subject: "Summer Camp Week 2",
    StartTime: new Date(2026, 5, 15, 9, 0),
    EndTime: new Date(2026, 5, 17, 12, 0),
    color: "#065E99",
    place: "Dauntless Athletics",
    cost: { day: 55, week: 150, label: "per athlete" },
    description: "A second three-day summer camp block with focused work on tumbling, jumps, conditioning, flexibility, and overall cheer skill development.",
    link: {
      href: "https://portal.iclasspro.com/dauntlessathletics/camps/28",
      innerText: "Register For Camp",
    },
    dateText: "June 15-17, 2026",
    timeText: "9:00 AM - 12:00 PM",
  },
];
