...
export const camps = [
  {
    ...
    date: dayjs.utc(new Date("2024-05-18")).format("dddd, MMMM Do"),
    time: "2:30 - 3:30 pm",
  ...
  {
    icon: <AirlineStopsIcon sx={{ ...classes.DauntlessCampIcon }} />,
    title: "Focused Tumbling Clinic Back ",
    date: dayjs.utc(new Date("2024-05-18")).format("dddd, MMMM Do"),
    time: "4:30 - 5:30 pm",
    place: "Dauntless Athletics",
    cost: 25,
  ...
  },
  {
    ...
    date: dayjs.utc(new Date("2024-05-19")).format("dddd, MMMM Do"),
    time: "1:00 - 4:00 pm",
    place: "Dauntless Athletics",
    cost: 69,
  ...
  {
    icon: <SportsGymnasticsIcon sx={{ ...classes.DauntlessCampIcon }} />,
    title: "Aerial Intensive with Coach Dom",
    date: dayjs.utc(new Date("2024-05-25")).format("dddd, MMMM Do"),
    time: "2:30 - 4:00 pm",
    place: "Dauntless Athletics",
    cost: 40,
    buttonText: "Register For Clinic",
  ...
  },
  {
    icon: <AirlineStopsIcon sx={{ ...classes.DauntlessCampIcon }} />,
    title: "Focused Tumbling Clinic Back Handspring",
    date: dayjs.utc(new Date("2024-06-08")).format("dddd, MMMM Do"),
    time: "2:30 - 3:30 pm",
    place: "Dauntless Athletics",
    cost: 25,
    buttonText: "Register For Clinic",
  ...
  {
    icon: <StarsIcon sx={{ ...classes.DauntlessCampIcon }} />,
    title: "June Tumbling Camp",
    date: dayjs.utc(new Date("2024-06-09")).format("dddd, MMMM Do"),
    time: "1:00 - 4:00 pm",
    place: "Dauntless Athletics",
    cost: 69,
    buttonText: "Register For Camp",
...
export const dauntlessClasses = [
  ...
  },
  {
    ...
    icon: <SportsGymnasticsIcon sx={{ ...classes.DauntlessClassesIcon, color: 'rgb(244, 67, 54)', }} />,
  },
  {
    ...
    icon: <FitnessCenterIcon sx={{ ...classes.DauntlessClassesIcon, color: 'rgb(255, 144, 105)', }} />,
  },
  {
    title: "Twisting",
    description:
  ...
  },
  {
    ...
    icon: <SportsKabaddiIcon sx={{ ...classes.DauntlessClassesIcon, color: 'rgb(243, 199, 37)', }} />,
  },
  {
    title: "Open Gym",
    description:
