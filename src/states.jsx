...
export const camps = [
  ...
  //   color: "#f01313",
  //   date: dayjs.utc(new Date("2024-12-14")).format("dddd, MMMM Do"),
  //   time: "2:30 - 3:30 pm",
  ...
  // {
  //   icon: <StarsIcon sx={{ ...classes.DauntlessCampIcon }} />,
  //   title: "December Tumbling Camp",
  //   color: "#f01313",
  //   date: dayjs.utc(new Date("2024-12-15")).format("dddd, MMMM Do"),
  //   time: "1:00 - 4:00 pm",
  //   place: "Dauntless Athletics",
  //   cost: 69,
  ...
  //   title: "Focused Tumbling Clinic Back Handspring",
  //   color: "#065E99",
  //   date: dayjs.utc(new Date("2024-11-16")).format("dddd, MMMM Do"),
  //   time: "2:30 - 3:30 pm",
  //   place: "Dauntless Athletics",
  //   cost: 25,
  //   buttonText: "Register For Clinic",
  ...
  // {
  //   icon: <StarsIcon sx={{ ...classes.DauntlessCampIcon }} />,
  //   title: "November Tumbling Camp",
  //   color: "#065E99",
  //   date: dayjs.utc(new Date("2024-11-17")).format("dddd, MMMM Do"),
  //   time: "1:00 - 4:00 pm",
  //   place: "Dauntless Athletics",
  //   cost: 69,
  //   buttonText: "Register For Camp",
